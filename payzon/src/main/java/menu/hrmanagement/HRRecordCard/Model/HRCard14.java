...
public class HRCard14 { // 사원 등록 테이블 // 社員登録テーブル (shain_touroku)

	public HRCard14() {} // 사원 등록 테이블 // 社員登録テーブル (shain_touroku)
	
	private Integer shain_ID; // 사원id(사원번호) // 社員ID（社員番号）
	private String koyou_keitai; // 고용형태(구분) // 雇用形態（区分）
	private String shain_namae; // 사원명(일어) // 社員名（日本語）
	private String shain_eigo_namae; // 사원명(영어) // 社員名（英語）
	private Date nyuusha_bi; // 입사일 // 入社日
	private Date taisha_bi; // 퇴사일 // 退職日
	private String bu; // 부서 // 部署
	private String yakushoku; // 직위 // 役職
	private String nai_gaikokuzin; // 내/외국인 // 内・外国人
	private String zyuumin_bangou; // 주민번호 // 住民番号
	private String zyuusho; // 주소 // 住所
	private String denwa_bangou; // 전화번호 // 電話番号
	private String keitai_bangou; // 휴대전화번호 // 携帯電話番号
	private String meiru_adoresu; // 메일주소 // メールアドレス
	private String sns; // sns // SNS
	private String busho_mei; // 부서명 // 部署名
	private String shokui_mei; // 직무명 // 職位名
	private String bikou; // 비고 // 備考
	
	//	인사기록카드 표에 들어감 // 人事記録カードに含まれる
