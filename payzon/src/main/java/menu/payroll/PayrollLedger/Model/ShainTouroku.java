...
public class ShainTouroku {
    ...
    private String shainEigoNamae;        // 사원 영어 이름 (社員英語名)
    ...
    public void setKoyouKeitai(String koyouKeitai) {
        this.koyouKeitai = koyouKeitai; // 고용 형태 설정 (雇用形態を設定する)
    }
    ...
    public void seㅁtShainNamae(String shainNamae) {
        this.shainNamae = shainNamae; // 사원 이름 설정 (社員名を設定する)
    }

    public String getShainEigoNamae() {
        return shainEigoNamae; // 사원 영어 이름 반환 (社員英語名を返す)
    }

    public void setShainEigoNamae(String shainEigoNamae) {
        this.shainEigoNamae = shainEigoNamae; // 사원 영어 이름 설정 (社員英語名を設定する)
    }
    ...
    public void setNyuushaBi(Date nyuushaBi) {
        this.nyuushaBi = nyuushaBi; // 입사일 설정 (入社日を設定する)
    }
    ...
    public void setTaishaBi(Date taishaBi) {
        this.taishaBi = taishaBi; // 퇴사일 설정 (退社日を設定する)
    }
    ...
    public void setYakushoku(String yakushoku) {
        this.yakushoku = yakushoku; // 직위 설정 (役職を設定する)
    }
    ...
    public void setNaiGaikokuzin(String naiGaikokuzin) {
        this.naiGaikokuzin = naiGaikokuzin; // 내외국인 설정 (内外国人を設定する)
    }
    ...
    public void setZyuuminBangou(String zyuuminBangou) {
        this.zyuuminBangou = zyuuminBangou; // 주민번호 설정 (住民番号を設定する)
    }
    ...
    public void setZyuusho(String zyuusho) {
        this.zyuusho = zyuusho; // 주소 설정 (住所を設定する)
    }
    ...
    public void setDenwaBangou(String denwaBangou) {
        this.denwaBangou = denwaBangou; // 전화번호 설정 (電話番号を設定する)
    }
    ...
    public void setKeitaiBangou(String keitaiBangou) {
        this.keitaiBangou = keitaiBangou; // 휴대전화번호 설정 (携帯電話番号を設定する)
    }
    ...
    public void setMeiruAdoresu(String meiruAdoresu) {
        this.meiruAdoresu = meiruAdoresu; // 이메일 설정 (メールアドレスを設定する)
    }
    ...
    public void setBikou(String bikou) {
        this.bikou = bikou; // 비고 설정 (備考を設定する)
    }
}
