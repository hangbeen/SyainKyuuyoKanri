...
public class TotalKouzyo {
    ...
    public void setKoujoId(int koujoId) {
        this.koujoId = koujoId; // 공제 항목 ID 설정 (控除項目IDを設定する)
    }
    ...
    public void setShotokuzei(double shotokuzei) {
        this.shotokuzei = shotokuzei; // 소득세 설정 (所得税を設定する)
    }
    ...
    public void setChihoShotokuzei(double chihoShotokuzei) {
        this.chihoShotokuzei = chihoShotokuzei; // 지방소득세 설정 (地方所得税を設定する)
    }
    ...
    public void setKoujoKamoku(String koujoKamoku) {
        this.koujoKamoku = koujoKamoku; // 공제 항목 설정 (控除項目を設定する)
    }
    ...
    public void setDaibuHoken(double daibuHoken) {
        this.daibuHoken = daibuHoken; // 4대보험 설정 (四大保険を設定する)
    }
    ...
    public void setKikandaniShotokuzei(double kikandaniShotokuzei) {
        this.kikandaniShotokuzei = kikandaniShotokuzei; // 기간단위소득세 설정 (期間単位所得税を設定する)
    }
    ...
    public void setKokuminNenkin(double kokuminNenkin) {
        this.kokuminNenkin = kokuminNenkin; // 국민연금 설정 (国民年金を設定する)
    }
    ...
    public void setKenkouHoken(double kenkouHoken) {
        this.kenkouHoken = kenkouHoken; // 건강보험 설정 (健康保険を設定する)
    }

    public double getChoukikaigoHoken() {
        return choukikaigoHoken; // 장기요양보험 반환 (長期介護保険を返す)
    }

    public void setChoukikaigoHoken(double choukikaigoHoken) {
        this.choukikaigoHoken = choukikaigoHoken; // 장기요양보험 설정 (長期介護保険を設定する)
    }
    ...
    public void setKoyouHoken(double koyouHoken) {
        this.koyouHoken = koyouHoken; // 고용보험 설정 (雇用保険を設定する)
    }
    ...
    public void setGojokaihi(double gojokaihi) {
        this.gojokaihi = gojokaihi; // 상호부조비 설정 (相互扶助費を設定する)
    }
    ...
    public void setZessaTani(String zessaTani) {
        this.zessaTani = zessaTani; // 절사 단위 설정 (切捨単位を設定する)
    }
    ...
    public void setShiyouUmu(String shiyouUmu) {
        this.shiyouUmu = shiyouUmu; // 사용 여부 설정 (使用有無を設定する)
    }
    ...
    public void setKeisanHouhou(String keisanHouhou) {
        this.keisanHouhou = keisanHouhou; // 계산 방법 설정 (計算方法を設定する)
    }
}
